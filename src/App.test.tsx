...
describe("App component test", () => {
  ...
  test("test", async () => {
    ...
    await act(async () => {
      await mockCloudWalletApi
        .get("https://test.com/api/users", {
          data: {
            mock: {
              reject: true,
              status: 404,
    ...
    expect(
      client.interceptors.response.handlers[0].fulfilled({ data: "foo" })
  ...
  test("test", async () => {
    ...
    jest
      .spyOn(ApiService, "getAccessTokenFromLocalStorage")
      .mockReturnValue(
        "eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9..0HTJnUedw491klJ5RfqAnJD_tmClp0dsq3DjcnRDvls"
      );
