  ...
  const approveVC = async () => {
    try {
      if (isJson(VCschemaData)) {
        ...
        db.collection("ripplefund-approved").add({
          username,
          payload,
          applicationID,
          approved: true,
  ...
  return (
    <div className="tutorial">
      <div className="tutorial__step">
        ...
        <p>
          <strong>Registered Company Name:</strong> {givenName}
        </p>
        <p>
          <strong>UEN:</strong> {uen}
        </p>
        <p>
          <strong>Date Of Incorporation:</strong> {issueDate}
        </p>
        <p>
          <strong>Company Email Address:</strong> {email}
        </p>
